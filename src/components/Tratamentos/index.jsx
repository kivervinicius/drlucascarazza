...
const link = <p>Nessa cirurgia, retiramos a lente intra ocular natural do olho (cristalino) que está doente para implantar uma lente artificial em seu lugar. Importante destacar que temos os melhores aparelhos disponíveis no mercado para realizar uma cirurgia com os mesmos níveis de segurança alcançados nos melhores centros de oftalmologia do Brasil e do mundo. para maiores informações sobre a cirurgia de catarata para maiores informações sobre a cirurgia de catarata clique  <a href="/catarata-cirurgia"> aqui</a>  Além disso, temos acesso a todas as lentes intra oculares que estão registradas no Brasil, desde as lentes ofertadas pelos planos de saúde até as especiais, com objetivo de proporcionar os melhores resultados visuais para cada paciente, respeitando sua individualidade. (para saber mais sobre lentes intra oculares, clique <a href="/lentes">aqui</a> </p>
const consultas = [
  {
    id: 1,
